...
(function(t, n) {
    ...
    function P(t) {
        for (var n = t.length, e = [0, 1], r = 2, i = 2; i < n; ++i) {
            for (; r > 1 && Xf(t[e[r - 2]], t[e[r - 1]], t[i]) <= 0;)
                --r;
            e[r++] = i
        }
        return e.slice(0, r)
    ...
    function Wn() {
        jn(), ++ed;
        for (var t, n = Lp; n;)
            (t = ad - n._time) >= 0 && n._call.call(null, t), n = n._next;
        --ed
    }
    function $n() {
    ...
    function Gn() {
        for (var t, n, e = Lp, r = 1 / 0; e;)
            e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : Lp = n);
        Rp = t, Jn(r)
    }
    function Jn(t) {
        if (!ed) {
        ...
        function n(t, n) {
            return function(e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++a < s;)
                    37 === t.charCodeAt(a) && (u.push(t.slice(c, a)), null != (i = Rv[r = t.charAt(++a)]) ? r = t.charAt(++a) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), u.push(r), c = a + 1);
        ...
        function r(t, n, e, r) {
            for (var i, o, u = 0, a = n.length, c = e.length; u < a;) {
                ...
                if (i = n.charCodeAt(u++), 37 === i) {
                    if (i = n.charAt(u++), o = B[i in Rv ? n.charAt(u++) : i], !o || (r = o(t, e, r)) < 0)
                        return -1
    ...
    function qr(t, n, r, i, o, u, a, c, s) {
        ...
        var h = dr(cr, sp),
            ...
            b = s("%B"),
            w = s("%Y"),
            M = [[a, 1, Jv], [a, 5, 5 * Jv], [a, 15, 15 * Jv], [a, 30, 30 * Jv], [u, 1, Qv], [u, 5, 5 * Qv], [u, 15, 15 * Qv], [u, 30, 30 * Qv], [o, 1, Kv], [o, 3, 3 * Kv], [o, 6, 6 * Kv], [o, 12, 12 * Kv], [i, 1, t_], [i, 2, 2 * t_], [r, 1, n_], [n, 1, e_], [n, 3, 3 * e_], [t, 1, r_]];
    ...
    function Gr(t, n, e, r, i, o, u) {
        var a,
            ...
            p = new Array(l);
        for (a = 0; a < l; ++a)
            (c = n[a]) && (p[a] = s = j_ + u.call(c, c.__data__, a, n), s in f ? i[a] = c : f[s] = c);
        for (a = 0; a < h; ++a)
            s = j_ + u.call(t, o[a], a, o), (c = f[s]) ? (r[a] = c, c.__data__ = o[a], f[s] = null) : e[a] = new $r(t, o[a]);
        for (a = 0; a < l; ++a)
            (c = n[a]) && f[p[a]] === c && (i[a] = c)
    }
    function Jr(t, n) {
    ...
    function Pi() {
        return new zi([[document.documentElement]], vy)
    }
    function qi(t, n) {
    ...
    function Ui(t, n, e) {
        ...
        function i(r) {
            ...
            if (ld(function() {
                ...
                for (e.state = Ny, a = new Array(l = e.tween.length), s = 0, f = -1; s < l; ++s)
                    (h = e.tween[s].value.call(t, t.__data__, e.index, e.group)) && (a[++f] = h);
                a.length = f + 1
            }
        }
        function o(n) {
            for (var r = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(u), e.state = Sy, 1), i = -1, o = a.length; ++i < o;)
                a[i].call(null, r);
    ...
    function Uu(t, n, e, r) {
        for (var i, o = am.length; o--;)
            Ru(i = am[o], t, n, e, r) && Lu(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > fm || Math.abs(i[0][1] - i[1][1]) > fm) || delete am[o]
    }
    function Du(t) {
        return om[t.index] = {
            site: t,
        ...
        for (i = 0; i < _; ++i)
            if (o = om[i]) {
                ...
                for (a = 0, s = c.length; a < s;)
                    p = Iu(o, am[c[a]]), d = p[0], v = p[1], f = Fu(o, am[c[++a % s]]), l = f[0], h = f[1], (Math.abs(d - l) > fm || Math.abs(v - h) > fm) && (c.splice(a, 0, am.push(Pu(u, p, Math.abs(d - t) < fm && r - v > fm ? [t, Math.abs(l - t) < fm ? h : r] : Math.abs(v - r) < fm && e - d > fm ? [Math.abs(h - r) < fm ? l : e, r] : Math.abs(d - e) < fm && v - n > fm ? [e, Math.abs(l - e) < fm ? h : n] : Math.abs(v - n) < fm && d - t > fm ? [Math.abs(h - n) < fm ? l : t, n] : null)) - 1), ++s);
                s && (y = !1)
            }
        if (y) {
            var g,
            ...
            for (i = 0, y = null; i < _; ++i)
                (o = om[i]) && (u = o.site, g = u[0] - t, m = u[1] - n, x = g * g + m * m, x < b && (b = x, y = o));
            if (y) {
                var w = [t, n],
                    M = [t, r],
                    T = [e, r],
    ...
    function Zu(t) {
        var n = t.circle,
            ...
            a = [t];
        $u(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < fm && Math.abs(r - c.circle.cy) < fm;)
            o = c.P, a.unshift(c), $u(c), c = o;
        a.unshift(c), Xu(c);
        for (var s = u; s.circle && Math.abs(e - s.circle.x) < fm && Math.abs(r - s.circle.cy) < fm;)
    ...
    function Gu(t) {
        ...
        if (im.insert(n, c), n || e) {
            if (n === e)
                return Xu(n), e = Wu(n.site), im.insert(c, e), c.edge = e.edge = zu(n.site, c.site), Hu(n), void Hu(e);
            if (!e)
    ...
    function na(t, n) {
        ...
        for (am = [], om = new Array(t.length), im = new ku, um = new ku;;)
            if (i = rm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x))
    ...
    function ga(n) {
        ...
        function u() {
            ...
            function o() {
                ...
                _ < h && (S *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, N in Am && Y.attr("cursor", Sm[N = Am[N]])), g < d && (A *= -1, t = p, p = y, y = t, t = d, d = g, g = t, N in Em && Y.attr("cursor", Sm[N = Em[N]])), E.selection && (z = E.selection), w && (h = z[0][0], _ = z[1][0]), M && (d = z[0][1], g = z[1][1]), z[0][0] === h && z[0][1] === d && z[1][0] === _ && z[1][1] === g || (E.selection = [[h, d], [_, g]], r.call(T), F.brush())
            }
            function u() {
            ...
            if (f.apply(this, arguments)) {
                ...
                "overlay" === N ? E.selection = z = [[l = n === Nm ? P : D[0], p = n === Tm ? q : D[1]], [v = n === Nm ? L : l, y = n === Tm ? R : p]] : (l = z[0][0], p = z[0][1], v = z[1][0], y = z[1][1]), h = l, d = p, _ = v, g = y;
        ...
        return e.move = function(t, e) {
            ...
            return arguments.length ? (s = "function" == typeof t ? t : ym([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), e) : s
        }, e.filter = function(t) {
    ...
    function _c(t, n, e, r, i, o) {
        if (e) {
            ...
            for (var s, f = i; r > 0 ? f > o : f < o; f -= c)
                s = Oa([u, -a * qx(f), -a * Ox(f)]), t.point(s[0], s[1])
        }
    }
    function yc(t, n) {
        n = Fa(n), n[0] -= t, Ha(n);
    ...
    function $c(t, n, e, r) {
        var i;
        if (null == t)
            i = e * Nx, r.point(-Tx, i), r.point(0, i), r.point(Tx, i), r.point(Tx, 0), r.point(Tx, -i), r.point(0, -i), r.point(-Tx, -i), r.point(-Tx, 0), r.point(-Tx, i);
    ...
    function rs(t) {
        ...
        return n.stream = function(t) {
            ...
            return arguments.length ? (S = null == t ? (k = l = h = p = null, Cb) : xc(k = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]), o()) : null == k ? null : [[k, l], [h, p]]
        }, n.scale = function(t) {
        ...
        }, n.fitExtent = Kc(n), n.fitSize = Qc(n), function() {
    ...
    var xs = "4.2.8",
        ...
        As = function(t, n) {
            ...
            if (null == n)
                for (; ++a < i;)
                    isNaN(e = Ss(t[a])) || (r = e - o, o += r / ++c, u += r * (e - o));
            else
                for (; ++a < i;)
                    isNaN(e = Ss(n(t[a], a, t))) || (r = e - o, o += r / ++c, u += r * (e - o));
            if (c > 1)
                return u / (c - 1)
        },
        Es = function(t, n) {
        ...
        Bs = function() {
            function t(t) {
                ...
                for (i = 0; i < u; ++i)
                    o = a[i], s <= o && o <= f && d[Ts(l, o, 0, h)].push(t[i]);
                return d
            }
            var n = Rs,
                e = Cs,
        ...
        Ws = function(t, n) {
            ...
            if (null == n)
                for (; ++o < i;)
                    isNaN(e = Ss(t[o])) ? --u : r += e;
            else
                for (; ++o < i;)
                    isNaN(e = Ss(n(t[o], o, t))) ? --u : r += e;
            if (u)
                return r / u
        },
        $s = function(t, n) {
            ...
            if (null == n)
                for (; ++o < i;)
                    isNaN(e = Ss(t[o])) || r.push(e);
            else
                for (; ++o < i;)
                    isNaN(e = Ss(n(t[o], o, t))) || r.push(e);
    ...
    i.prototype = o.prototype = {
        ...
        clear: function() {
            for (var t in this)
                t[0] === of && delete this[t]
        },
        keys: function() {
            var t = [];
            for (var n in this)
                n[0] === of && t.push(n.slice(1));
            return t
        },
        values: function() {
            var t = [];
            for (var n in this)
                n[0] === of && t.push(this[n]);
            return t
        },
        entries: function() {
            var t = [];
        ...
        each: function(t) {
            for (var n in this)
                n[0] === of && t(this[n], n.slice(1), this)
        }
    };
    var uf = function() {
            function t(n, i, u, a) {
        ...
        xl = function() {
            function t() {
                ...
                if (c || (c = t = L()), l < f && (s = l, l = f, f = s), l > _l)
                    if (d > ml - _l)
                        c.moveTo(l * Math.cos(h), l * Math.sin(h)), c.arc(0, 0, l, h, p, !v), f > _l && (c.moveTo(f * Math.cos(p), f * Math.sin(p)), c.arc(0, 0, f, p, h, v));
                    else {
                        var _,
                            y,
                            g = h,
    ...
    var Jh,
        ...
        pp = function(t, n) {
            var e,
                r,
                i,
                o = lp.lastIndex = hp.lastIndex = 0,
                u = -1,
                a = [],
                c = [];
            for (t += "", n += ""; (e = lp.exec(t)) && (r = hp.exec(n));)
        ...
        Np = function(t, n) {
            var e,
                ...
                h = f * f + l * l;
            if (h < Tp)
                r = Math.log(s / u) / bp, e = function(t) {
    ...
    var Av,
        Ev = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"],
        Cv = function(t) {
            function n(t) {
                function n(t) {
                    var n,
    ...
    var _y = function(t) {
            return "string" == typeof t ? new zi([[document.querySelector(t)]], [document.documentElement]) : new zi([[t]], vy)
        },
        yy = function(t) {
        ...
        Cy = function(t, n) {
            ...
            if (o) {
                n = null == n ? null : n + "";
                for (i in o)
                    (e = o[i]).name === n ? (r = e.state > Ty && e.state < Sy, e.state = Ay, e.timer.stop(), r && e.on.call("interrupt", t, t.__data__, e.index, e.group), delete o[i]) : u = !1;
        ...
        jy = function(t) {
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
                for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)
                    (a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, Ey(l[h], n, e, h, l, Ri(a, e)));
    ...
    var ng = [null],
        eg = function(t, n) {
            ...
            if (i) {
                n = null == n ? null : n + "";
                for (r in i)
                    if ((e = i[r]).state > My && e.name === n)
                        return new so([[t]], ng, n, +r)
            }
            return null
        },
        ...
        Pg = function() {
            function t(t) {
                var r,
                    ...
                    h = {};
                for (i = 0; i < f; ++i)
                    r = t[i], a = l[i] = new Uo(r), null != (c = n(r, i, t)) && (c += "") && (s = Eg + (a.id = c), h[s] = s in h ? zg : a);
                for (i = 0; i < f; ++i)
            ...
            function e(n) {
                for (var e = 0, r = t.length; e < v; ++e)
                    for (var i, o, u, s, f, h, p, d = 0; d < r; ++d)
                        i = t[d], o = i.source, u = i.target, s = u.x + u.vx - o.x - o.vx || jg(), f = u.y + u.vy - o.y - o.vy || jg(), h = Math.sqrt(s * s + f * f), h = (h - c[d]) / h * n * a[d], s *= h, f *= h, u.vx -= s * (p = l[d]), u.vy -= f * p, o.vx += s * (p = 1 - p), o.vy += f * p
            }
            function r() {
                if (s) {
                    var n,
        ...
        Zg = function() {
            ...
            function r(t, n, e, r) {
                ...
                var i = t.x - o.x,
                    ...
                    p = i * i + c * c;
                if (h * h / l < p)
                    return p < f && (0 === i && (i = jg(), p += i * i), 0 === c && (c = jg(), p += c * c), p < s && (p = Math.sqrt(s * p)), o.vx += i * t.value * u / p, o.vy += c * t.value * u / p), !0;
                if (!(t.length || p >= f)) {
            ...
            function o() {
                if (l.apply(this, arguments)) {
                    var n,
                        ...
                        o = r.length;
                    for (n = 0; n < o; ++n)
                        (e = c(r[n].identifier, i, gy, this, arguments)) && (gu(), e("start"))
                }
            }
            function u() {
                var n,
        ...
        triangles: function() {
            ...
            return this.cells.forEach(function(e, r) {
                for (var i, o = e.site, u = e.halfedges, a = -1, c = u.length, s = n[u[c - 1]], f = s.left === o ? s.right : s.left; ++a < c;)
                    i = f, s = n[u[a]], f = s.left === o ? s.right : s.left, r < i.index && r < f.index && Ku(o, i, f) < 0 && t.push([o.data, i.data, f.data])
            }), t
        },
        links: function() {
        ...
        _m = function() {
            ...
            function h() {
                if (y.apply(this, arguments)) {
                    var n,
                        ...
                        u = o.length;
                    for (oa(), n = 0; n < u; ++n)
                        e = o[n], r = gy(this, o, e.identifier), r = [r, this.__zoom.invert(r), e.identifier], i.touch0 ? i.touch1 || (i.touch1 = r) : i.touch0 = r;
            ...
            function p() {
                var n,
                    ...
                    l = f.length;
                for (vm(), v && (v = clearTimeout(v)), n = 0; n < l; ++n)
                    o = f[n], u = gy(this, f, o.identifier), s.touch0 && s.touch0[2] === o.identifier ? s.touch0[0] = u : s.touch1 && s.touch1[2] === o.identifier && (s.touch1[0] = u);
            ...
            return n.transform = function(t, n) {
                ...
                return arguments.length ? (g = "function" == typeof t ? t : pm([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), n) : g
        ...
        Bm = function() {
            function t() {
                var t,
                    ...
                    _ = i.apply(this, a) - Um,
                    y = o.apply(this, a) - Um;
                if (u || (u = t = L()), u.moveTo(p, d), u.arc(0, 0, f, l, h), l === _ && h === y || (u.quadraticCurveTo(0, 0, v * qm(_), v * Lm(_)), u.arc(0, 0, v, _, y)), u.quadraticCurveTo(0, 0, p, d), u.closePath(), t)
    ...
    var Hm,
        ...
        Jx = function(t) {
            ...
            if (Qm = Jm = -(Zm = Gm = 1 / 0), rx = [], Hx(t, Gx), e = rx.length) {
                for (rx.sort(Ka), n = 1, r = rx[0], o = [r]; n < e; ++n)
                    i = rx[n], tc(r, i[0]) || tc(r, i[1]) ? (Qa(r[0], i[1]) > Qa(r[0], r[1]) && (r[1] = i[1]), Qa(i[0], r[1]) > Qa(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
                for (u = -(1 / 0), e = o.length - 1, n = 0, r = o[e]; n <= e; r = i, ++n)
                    i = o[n], (a = Qa(r[1], i[0])) > u && (u = a, Zm = i[0], Jm = r[1])
            }
            return rx = ix = null, Zm === 1 / 0 || Gm === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Zm, Gm], [Jm, Qm]]
        },
        Qx = {
            sphere: Ca,
            point: nc,
    ...
    var eb,
        ...
        Ab = function() {
            ...
            }, t.extentMajor([[-180, -90 + wx], [180, 90 - wx]]).extentMinor([[-180, -80 - wx], [180, 80 + wx]])
        },
        Eb = function(t, n) {
            var e = t[0] * Ex,
                r = t[1] * Ex,
                ...
                function h() {
                    ...
                    if (v.pop(), p.push(v), v = null, a)
                        if (1 & i) {
                            ...
                            a > 1 && 2 & i && u.push(u.pop().concat(u.shift())), d.push(u.filter(Hc))
                }
                var p,
                    d,
                    v,
            ...
            function i(t) {
                ...
                return {
                    ...
                    point: function(l, h) {
                        ...
                        if (!n && (a = i = v) && t.lineStart(), v !== i && (p = o(n, d), (yb(n, p) || yb(d, p)) && (d[0] += wx, d[1] += wx, v = r(d[0], d[1]))), v !== i)
        ...
        cw = function() {
            ...
            return t.invert = function(t) {
                ...
                var e = c.scale(),
                    r = +t[0],
                    a = +t[1];
                return i = c.translate(t).clipExtent([[r - .455 * e, a - .238 * e], [r + .455 * e, a + .238 * e]]).stream(l), o = s.translate([r - .307 * e, a + .201 * e]).clipExtent([[r - .425 * e + wx, a + .12 * e + wx], [r - .214 * e - wx, a + .234 * e - wx]]).stream(l), u = f.translate([r - .205 * e, a + .212 * e]).clipExtent([[r - .214 * e + wx, a + .166 * e + wx], [r - .115 * e - wx, a + .234 * e - wx]]).stream(l), n()
